<div class="form-body">
    ...
    <div class="form-group">
        <label class="col-md-2 control-label">Is Shown On Menu?</label>
        <div class="col-md-9">
    ...
    <div class="form-group">
        <label class="col-md-2 control-label">Is Publicly Visible?</label>
        <div class="col-md-9">
...
<div class="form-actions">
    <div class="row">
        <div class="col-md-12 text-center">
            ...
            <a class="btn red-sunglo" href="{{ route('modules.index', ['domain' => app('request')->route()->parameter('company')]) }}">Cancel</a>
        </div>
    </div>
</div>